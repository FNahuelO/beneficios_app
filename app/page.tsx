...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-[#EFF7FE]">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Button
                size="lg"
                asChild
                className="bg-[#F3B229] text-blue-900 hover:bg-[#F3B229]/80"
              >
                <Link href="/registro">
                  Registrate Gratis
      ...
      {/* Features Section */}
      <section className="relative overflow-hidden py-16 h-[70vh] flex flex-col items-center justify-center">
        ...
        <div className="absolute top-2 left-0 right-0 h-1.5 bg-[#00438A]" />
        ...
        <div className="container relative ">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[#FFC958]">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="relative flex flex-col rounded-lg bg-blue-900/60 backdrop-blur-sm p-6 pt-3 pb-12"
                >
                  <div className="mb-4 h-16 w-16 flex items-center justify-center rounded-lg bg-[#00438A] shadow self-end">
                    <Icon className="h-8 w-8 text-[#F3B229]" />
                  </div>
                  <h3 className="mb-4 text-xl font-bold text-white text-start">{feature.title}</h3>

                  <p className="text-white/90 text-sm">{feature.description}</p>
                  <div className="absolute bottom-0 left-0 right-0 h-2 bg-[#F3B229] rounded-b-3xl" />
                </div>
              )
            })}
          </div>
        </div>
        <div className="absolute bottom-2 left-0 right-0 h-1.5 bg-[#00438A]" />
        <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-[#F3B229]" />
      </section>
      ...
      >
        ...
        <div
          className="absolute right-0 top-0 bottom-0 w-1/2 bg-contain bg-right bg-no-repeat"
          style={{ backgroundImage: 'url(/banner.png)' }}
        />

        {/* Overlay con degradado para que la imagen se vea progresivamente */}
        <div className="absolute inset-0 bg-linear-to-r from-[#22396B] via-[#22396B]/50 to-transparent" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="shrink-0 z-10">
              <Button
                size="lg"
                asChild
                className="bg-[#F3B229] text-white hover:bg-[#F3B229]/90 font-bold px-10 py-6 text-md rounded-2xl"
              >
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-3xl text-center py-24">
            ...
            <Button
              size="lg"
              asChild
              className="bg-[#F3B229] text-[#00438A] hover:bg-[#F3B229]/90 font-bold px-10 py-6 text-lg rounded-2xl"
            >
              <Link href="/registro">Registrarte</Link>
            </Button>
          </div>
